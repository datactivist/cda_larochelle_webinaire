...
.pull-right-narrow[J'ai quitté Saint-Denis, 93, après une enfance en grande banlieue parisienne et une adolescence champenoise (Troyes, Aube).
...
* acheteur : *quel est le prix des logements à l'achat dans l'agglo ?*
...
* [OpenStreetMap](openstreetmap.org/) sert de fonds de carte à d'innombrables applications ;
...
[L'application Modalis](https://modalis.fr/fr/page/2) mise en place par le syndicat Nouvelle-Aquitaine Mobilités construit ses cartes en centralisant les données de 25 autorités organisations de la mobilité dans la région, dont Yélo.

Yélo récupère ces données auprès des deux délégataires en temps réel.]
...
* Combien le centre de vaccination de Nieul a-t-il réalisé d'injection la semaine du 17 mai 2021 ?
