...
# Renons sur les notions<br>évoquées la semaine dernière
...
La formalisation juridique s'est opérée sur deux niveaux différents et successifs :
...
Les standards de données sont des conventions portant sur **la forme** des jeux de données :
